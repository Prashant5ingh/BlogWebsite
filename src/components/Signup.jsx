    ...
    const create = async (data) => {
        ...
        try {
            ...
            if (userData) {
                ...
                // After getting current user then we need to update the store
                if (userData) dispatch(login(userData));

                // navigate after passing user data
                navigate("/")
            }
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10`}>
                ...
                <form onSubmit={handleSubmit(create) //It gives data from create, to fetch data we need register
                }>
